...
# DATABASE_URL is automatically set by Render for PostgreSQL databases
...
# Check if we have a PostgreSQL or other database URL (production)
if db_url and ("postgresql" in db_url or "postgres" in db_url):
    DB_URL = db_url
    print("DEBUG: Using PostgreSQL from DATABASE_URL env var")
