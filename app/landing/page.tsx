...
Keep it under {length} words.`}</div>
          ...
          {[
            {
              step: '1',
              title: 'Save It',
              desc: 'Found a prompt that works? Save it with tags, categories, and metadata so you can find it later.',
              icon: '📖',
            },
            {
              step: '2',
              title: 'Tweak It',
              desc: 'Use variables like {topic} and get AI-powered suggestions to make your prompts sharper.',
              icon: '🔧',
            },
            {
              step: '3',
              title: 'Test It',
              desc: 'Run your prompt against real models. Compare outputs. See token counts and response times.',
              icon: '🧪',
            },
            {
              step: '4',
              title: 'Version It',
              desc: 'Every change is tracked. Roll back to any version. Compare diffs side by side.',
              icon: '📋',
            },
          ].map(item => (
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            {
              quote: 'I used to keep prompts in Notes. Now I actually find them when I need them.',
              attr: 'Version history + tags',
            },
            {
              quote: 'Testing before shipping saved me from a prompt that sounded great but hallucinated every time.',
              attr: 'Built-in test runner',
            },
            {
              quote: 'The AI suggestions caught things I would have never thought to specify.',
              attr: 'Smart refinement',
            },
          ].map((item, i) => (
            <div key={i} style={{
              padding: '1.5rem',
              ...
              <p style={{ fontSize: '0.95rem', color: 'var(--color-foreground)', lineHeight: '1.6', marginBottom: '1rem', fontStyle: 'italic', margin: '0 0 1rem 0' }}>
