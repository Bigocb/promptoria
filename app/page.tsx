    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(to bottom, #0f172a, #1e293b)', color: 'white', padding: '2rem' }}>
      ...
      <main>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
          <div style={{ border: '1px solid #475569', borderRadius: '0.5rem', padding: '1.5rem', backgroundColor: '#1e293b', cursor: 'pointer' }} onClick={() => (window.location.href = '/snippets')}>
          ...
          <div style={{ border: '1px solid #475569', borderRadius: '0.5rem', padding: '1.5rem', backgroundColor: '#1e293b', cursor: 'pointer' }} onClick={() => (window.location.href = '/prompts')}>
          ...
          <div style={{ border: '1px solid #475569', borderRadius: '0.5rem', padding: '1.5rem', backgroundColor: '#1e293b', cursor: 'pointer' }} onClick={() => (window.location.href = '/history')}>
          ...
          <div style={{ border: '1px solid #475569', borderRadius: '0.5rem', padding: '1.5rem', backgroundColor: '#1e293b', cursor: 'pointer' }} onClick={() => (window.location.href = '/test')}>
        ...
        <div style={{ border: '1px solid #475569', borderRadius: '0.5rem', padding: '1.5rem', backgroundColor: '#1e293b' }}>
          ...
          <div style={{ color: '#cbd5e1' }}>
            <p style={{ marginBottom: '1rem' }}>Promptoria is now running! Click on any section above to navigate.</p>
            <p style={{ marginBottom: '0.5rem' }}>Features:</p>
            <ul style={{ marginLeft: '1.5rem', listStyle: 'disc' }}>
              <li>Create reusable snippets</li>
              <li>Build complex prompts from snippets</li>
              <li>Track versions and changes</li>
              <li>Test prompts with real LLM APIs</li>
            </ul>
          </div>
        </div>
      </main>
