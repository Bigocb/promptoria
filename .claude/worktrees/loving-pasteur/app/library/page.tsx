...
export default function LibraryPage() {
  ...
  return (
    <div style={{ padding: '2rem', minHeight: '100vh', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: '2rem', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
          ...
          {loading ? (
            ...
            <div>
              ...
              {selectedType.categories.length === 0 ? (
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(250px, 100%), 1fr))', gap: '1.5rem', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
