...
export default function TestRunnerPage() {
  ...
  return (
    <div style={{ padding: '2rem', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: '2rem', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
        {/* Control Panel */}
        ...
        <div style={{ minWidth: 0, overflow: 'hidden' }}>
          ...
          {output && results.length > 0 && (
            <div className="card" style={{ marginBottom: '1.5rem', backgroundColor: 'var(--color-backgroundAlt)', padding: '1rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
                <div>
