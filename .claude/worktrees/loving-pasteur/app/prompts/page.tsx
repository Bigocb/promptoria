...
export default function WorkbenchPage() {
  ...
  return (
    <div style={{ padding: '2rem', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '2rem', overflowX: 'hidden', width: '100%', boxSizing: 'border-box' }}>
        {/* Main Editor */}
        ...
        {/* Right Sidebar */}
        <aside style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', minWidth: 0, overflow: 'hidden' }}>
